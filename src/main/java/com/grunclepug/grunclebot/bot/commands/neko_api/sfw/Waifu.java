...
public class Waifu extends ListenerAdapter {
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        if(args[0].equalsIgnoreCase(Config.getPrefix() + "waifu")) {
            String title = "Absolute Waifu Material:";
            int color = 0x8904B1;

            try {
                EmbedBuilder builder = new ImageAPI().getEmbed(NekoAPI.WAIFU, title, color);
